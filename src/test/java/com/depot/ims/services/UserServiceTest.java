...
/**
 * Unit tests for the UserService class. Validates the functionality of user management operations,
 * including retrieval, confirmation, deletion, and updating of user details. Utilizes Mockito to
 * mock the UserRepository for isolated testing of service logic.
 */
public class UserServiceTest {
  ...
  /**
   * Tests retrieving a user by ID or username. Verifies correct user retrieval and handling of null
   * input scenarios.
   */
  @Test
  void testGetUser() {
  ...
  /**
   * Tests user authentication by confirming username and password. Verifies responses for correct
   * credentials, incorrect password, nonexistent user, and missing inputs.
   */
  @Test
  void testConfirm() {
  ...
  /**
   * Tests the deletion of an existing user. Verifies successful deletion and proper handling when a
   * user is found.
   */
  @Test
  ...
  /**
   * Tests the deletion of an user that do not exist. Verifies successful deletion and proper
   * handling when a user is not found.
   */
  @Test
  ...
  void testUpdateUserUserNotFound() {
    ...
    ResponseEntity<?> response =
        userService.updateUser(userId, "newUsername", "newPassword", "newPosition");
    assertEquals("User not found by user id!", response.getBody());
  }
  ...
  /**
   * Tests updating user information, handling cases where the user is found and a successful
   * update.
   */
  @Test
