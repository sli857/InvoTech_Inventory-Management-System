...
/**
 * Integration tests for the availability entity using the H2 in-memory database. Tests validate the
 * basic CRUD operations provided by AvailabilityRepository.
 */
@DataJpaTest
@TestPropertySource(
    properties = {
...
public class AvailabilityTest {
  ...
  /**
   * Tests retrieval of all availability entities by site id. Validates that the findBySiteId
   * operation can successfully retrieve the correct number of availability entities, and check the
  ...
  /**
   * Tests retrieval of all availability entities by item id. Validates that the findByItemId
   * operation can successfully retrieve the correct number of availability entities, and check the
   * content of the return.
   */
  @Test
  ...
  /**
   * Tests retrieval of a specific availability entity by item id and site id. Validates that the
   * findBySiteIdAndItemId operation can successfully retrieve the correct availability entity
   */
  @Test
  void testFindBySiteIdAndItemId() {
    ...
    Availability result =
        availabilityRepository.findBySiteIdAndItemId(site.getSiteId(), item.getItemId());
  ...
  /**
   * Tests retrieval of a list of site entities by a list of item Validates that the
   * findSitesByItems operation can successfully retrieve the correct sites entity
   */
  @Test
  ...
  /**
   * Tests retrieval of a list of site entities by an item Validates that the findSitesByOneItem
   * operation can successfully retrieve the correct sites entity
   */
  @Test
