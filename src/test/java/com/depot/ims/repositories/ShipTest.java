...
class ShipTest {
    ...
    void setUp() {
        ...
        Shipment shipment1 =
                createShipment(123, 456, "Warehouse A", System.currentTimeMillis(), 86400000);
    ...
    private void createShip(Shipment shipment, Item item, int quantity) {
        Ship ship = Ship.builder().shipmentId(shipment).itemId(item).quantity(quantity).build();
    ...
    private Item createItem(String name, double price) {
        Item item = Item.builder().itemName(name).itemPrice(price).build();
    ...
    private Shipment createShipment(
            ...
            long estimatedArrivalTimeMillis) {
        Shipment shipment =
                Shipment.builder()
                        .source(source)
