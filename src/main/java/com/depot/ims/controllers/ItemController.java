...
/**
 * ItemController class provides API endpoints for managing items within the Inventory Management
 * System. This controller supports operations such as creating, updating, and fetching item
 * details.
 */
@RestController
...
public class ItemController {
  ...
  /**
   * Endpoint to add a new item. Accepts item details in the form of a JSON object.
   *
  ...
  /**
   * Endpoint to update the details of an existing item. This method allows partial updates to item
   * properties.
   *
