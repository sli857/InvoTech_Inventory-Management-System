...
/**
 * ShipController class provides API endpoints for managing ships within the Inventory Management
 * System. This controller supports operations such as creating, updating, and fetching ship
 * details.
 */
@RestController
...
public class ShipController {
  ...
  public List<Ship> getShipsByItemIdAndShipmentId(
      @PathVariable Long itemId, @PathVariable Long shipmentId) {
    return shipRepository.findByItemIdAndShipmentId(itemId, shipmentId);
  }

  /**
   * Endpoint to add a new ship. Accepts ship details in the form of a JSON object.
   *
