...
/**
 * ShipmentController class provides API endpoints for managing shipments within the Inventory
 * Management System. This controller supports operations such as creating, updating, deleting, and
...
public class ShipmentController {
  ...
  public ShipmentController(
      ShipmentRepository shipmentsRepository, ShipmentService shipmentService) {
  ...
  /**
   * Endpoint to update the details of an existing shipment. This method allows partial updates to
   * shipment properties.
   *
  ...
  public ResponseEntity<?> updateShipment(
      @RequestParam(value = "shipmentId") Long shipmentId,
      @RequestParam(value = "source", required = false) Long newSource,
      @RequestParam(value = "destination", required = false) Long newDestination,
      @RequestParam(value = "currentLocation", required = false) String newCurrentLocation,
      @RequestParam(value = "departureTime", required = false) Timestamp newDepartureTime,
      @RequestParam(value = "estimatedArrivalTime", required = false)
          Timestamp newEstimatedArrivalTime,
      @RequestParam(value = "actualArrivalTime", required = false) Timestamp newActualArrivalTime,
      @RequestParam(value = "shipmentStatus", required = false) String newShipmentStatus) {
  ...
  /**
   * Endpoint to add a new shipment. Accepts shipment details in the form of a JSON object.
   *
