...
public class ShipService {
  ...
  public ResponseEntity<?> addShip(Ship ship) {
    // Validate
    if (ship == null
        || ship.getShipmentId() == null
        || ship.getItemId() == null
        || ship.getQuantity() == null) {
    ...
    Shipment destination =
        shipmentRepository.findByShipmentId(ship.getShipmentId().getDestination());
    ...
    availabilityRepository
        .findBySiteIdAndItemId(ship.getShipmentId().getDestination(), ship.getItemId().getItemId())
        .setQuantity(
            availabilityRepository
                    .findBySiteIdAndItemId(
