...
/**
 * UserService provides business logic for handling user operations within the Inventory Management
 * System. This includes creating, updating, retrieving, and deleting user information.
 */
@Service
public class UserService {
  ...
  /**
   * Updates the details of an existing user using their ID. Allows for partial updates where only
  ...
  public ResponseEntity<?> updateUser(
      Long userId, String newUsername, String newPassword, String newPosition) {
   ...
   * @return ResponseEntity<?> Returns OK with the user details or Bad Request if neither ID nor
   ...
   * @return ResponseEntity<?> Returns OK if the user exists and the password matches, or Bad
   *     Request on error.
   */
  public ResponseEntity<?> confirm(String username, String password) {
    // a unique user id will be provided by the user
    if (username == null
