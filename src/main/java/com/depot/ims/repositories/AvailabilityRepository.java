 ...
 * Extends JpaRepository to provide standard CRUD operations and includes custom queries for finding
 * availabilities by their ID.
 */
@Repository
public interface AvailabilityRepository extends JpaRepository<Availability, Long> {
  ...
  /**
   * find list of sites that contains all the items in the item list Uses a custom JPQL query to
   * retrieve a specific availability.
   *
  ...
  /**
   * find list of sites that contains the item Uses a custom JPQL query to retrieve a specific
   * availability.
   *
