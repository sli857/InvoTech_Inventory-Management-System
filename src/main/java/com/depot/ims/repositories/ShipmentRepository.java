...
/**
 * Repository interface for CRUD operations and custom queries on the Shipment entity. Extends
 * JpaRepository to provide basic CRUD operations and includes additional queries to find shipments
 * based on various attributes like source, destination, and status.
 */
